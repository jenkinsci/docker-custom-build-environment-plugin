...
class DockerCli implements Docker {
    ...
    private static boolean debug = Boolean.getBoolean(DockerCli.class.getName()+".debug");
    ...
    public DockerCli(DockerServerEndpoint dockerHost, String dockerInstallation, AbstractBuild build, Launcher launcher, TaskListener listener, boolean verbose) throws IOException, InterruptedException {
